...
path_to_template = "E:\Capstone\Capstone_FX\ExcelFiles\Template\JASWInvoiceTemplate.xlsx"
...
"""
home = "E:\Capstone\Capstone_FX\ExcelFiles\DataFiles\DataFile.txt"
...
if(customer_info_array[3] != "NA"):
    ws[client_info_cells[0]] = customer_info_array[3]
else:
...
ws[additional_cost_cell[0]] = datetime.date.today()
ws[additional_cost_cell[1]] = additional[0]
ws[additional_cost_cell[2]] = additional[1]

total_cost += int(float(customer_bid)) + int(float(additional[1]))
total_cost =  str(total_cost)
ws[total_cell] = total_cost


cust_name =  customer_info_array[0] + " " + customer_info_array[1]
path_to_save = "E:\Capstone\Capstone_FX\ExcelFiles\CustomerFiles\\"+cust_name
